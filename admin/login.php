...
<body background="admin_image\admin2.jpg">
      ...
      <div class="row justify-content-center">
          <div class="col-lg-6">
              <h1 class="mt-4 mb-3" style="color:white;">
                  &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<b>LIFE-LINKER</b>
                  <br>&nbsp&nbsp<b>Admin Login Portal</b>
                </h1>

            </div>
      </div>
      <div class="card" style="height:250px; background-image:url('admin_image/rbc.jpg');">
          <div class="card-body">
